...
from bancapueyo.items import Article


class BancapueyoSpider(scrapy.Spider):
    name = 'bancapueyo'
    start_urls = ['https://www.bancapueyo.es/blog']

    def parse(self, response):
        links = response.xpath('//a[@class="k2ReadMore"]/@href').getall()
